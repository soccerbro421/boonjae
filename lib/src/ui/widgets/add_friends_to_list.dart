...
class AddFriendsToList extends StatefulWidget {
  ...
  @override
  State<AddFriendsToList> createState() => _AddFriendsToListState();
}

class _AddFriendsToListState extends State<AddFriendsToList> {
